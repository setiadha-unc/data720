...
import time
import hashlib
# This try below is intended for the grader. 
# Data is pickled using python 3.9.5. However, the grader is runing python 3.7. 
#Therefore, it will run pickle5 to unpickle the data. Furthermore, pickle5 does not exist at the moment for python 3.9.5.
try:
...
Site = 'https://comp116fa21.cs.unc.edu/'
PRECISION = 5
...
try:
    ...
    def start(assignment, unlocker=False, section=0, logger=True):
        ...
        if logger:
           try:
               import logger
               logger.start(assignment + '.ipynb', f'Fall 2021 COMP116 {assignment}')
